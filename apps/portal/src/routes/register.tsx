...
const RegisterSchema = v.object({
  orgName: v.pipe(v.string(), v.minLength(2, 'Organization name must be at least 2 characters')),
...
function RegisterPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    const result = v.safeParse(RegisterSchema, { orgName, name, email, password })
    if (!result.success) {
    ...
    <div className="min-h-screen flex items-center justify-center bg-[#09090b] px-4 py-12">
      <div className="w-full max-w-sm">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-zinc-500 mt-1">Create your restaurant account</p>
        </div>
