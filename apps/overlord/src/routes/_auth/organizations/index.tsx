    ...
    <div className="p-6 space-y-5 max-w-6xl mx-auto">
      ...
      <div className="bg-zinc-900 border border-zinc-800 rounded-xl overflow-hidden">
        ...
        <div className="hidden md:grid grid-cols-[1fr_120px_100px_100px_80px_36px] gap-4 px-5 py-3 border-b border-zinc-800">
          {['Organization', 'Plan', 'Branches', 'Members', 'Status', ''].map((h) => (
          ...
          {orgs.map((org) => (
            ...
            >
              <div className="flex items-center gap-3 min-w-0">
                <div className="w-8 h-8 rounded-lg bg-zinc-800 flex items-center justify-center text-xs font-bold text-zinc-400 flex-shrink-0 group-hover:bg-zinc-700">
              ...
              <div className="flex items-center gap-3 min-w-0">
                ...
                <div className="min-w-0">
                  ...
                  <div className="flex items-center gap-2 mt-0.5">
                    <StatusBadge status={org.subscription?.status ?? 'none'} />
                    <span className="text-xs text-zinc-600">{org.branchCount} branches</span>
                  </div>
                </div>
              </div>
